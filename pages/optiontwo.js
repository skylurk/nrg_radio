...
const OptionTwo = () => {
    return (
        <div className='flex flex-row relative '>
            ...
            <div className="flex flex-col justify-center items-center absolute h-[80vh] w-[35%] rounded-lg shadow-lg bg-red-600/0 text-white top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
